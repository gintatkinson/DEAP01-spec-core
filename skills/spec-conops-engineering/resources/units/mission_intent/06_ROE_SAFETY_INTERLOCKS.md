...
## 6. {{INTERLOCK_SECTION_TITLE:Rules of Engagement (ROE) & Weapon/Sensor Interlocks}}
...
- **{{INTERLOCK_01_TAG:ROE-01}}: Safe Operating Clearance Interlock**
...
- **{{INTERLOCK_02_TAG:ROE-02}}: Multi-Modal Positive Condition Verification**
...
- **{{INTERLOCK_03_TAG:ROE-03}}: Dual-Consent Cryptographic Authorization Interlock**
...
- **{{INTERLOCK_04_TAG:ROE-04}}: Human-on-the-Loop (HOTL) Veto Authority Interlock**
...
- **{{INTERLOCK_05_TAG:ROE-05}}: Protected Zone & Exclusion Boundary Interlock**
...
- **{{INTERLOCK_06_TAG:ROE-06}}: Communication Loss Autonomous Safing Interlock**
